...
function api_v1_foodcategory_update(payload) {
  return yellowmorningAPI.put(`/api/v1/foodcategory/${payload.id}/`, payload.data);
}

function api_v1_foodcategory_partial_update(payload) {
  return yellowmorningAPI.patch(`/api/v1/foodcategory/${payload.id}/`, payload.data);
}
...
function api_v1_foodconsumption_update(payload) {
  return yellowmorningAPI.put(`/api/v1/foodconsumption/${payload.id}/`, payload.data);
}

function api_v1_foodconsumption_partial_update(payload) {
  return yellowmorningAPI.patch(`/api/v1/foodconsumption/${payload.id}/`, payload.data);
}
...
function rest_auth_password_reset_confirm_create(payload) {
  return yellowmorningAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}
...
function rest_auth_registration_verify_email_create(payload) {
  return yellowmorningAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
