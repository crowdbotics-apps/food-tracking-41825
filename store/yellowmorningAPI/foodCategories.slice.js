...
export const api_v1_foodcategory_list = createAsyncThunk("foodCategories/api_v1_foodcategory_list", async payload => {
  const response = await apiService.api_v1_foodcategory_list(payload);
  return response.data;
});
export const api_v1_foodcategory_create = createAsyncThunk("foodCategories/api_v1_foodcategory_create", async payload => {
  const response = await apiService.api_v1_foodcategory_create(payload);
  return response.data;
});
export const api_v1_foodcategory_retrieve = createAsyncThunk("foodCategories/api_v1_foodcategory_retrieve", async payload => {
  const response = await apiService.api_v1_foodcategory_retrieve(payload);
  return response.data;
});
export const api_v1_foodcategory_update = createAsyncThunk("foodCategories/api_v1_foodcategory_update", async payload => {
  const response = await apiService.api_v1_foodcategory_update(payload);
  return response.data;
});
export const api_v1_foodcategory_partial_update = createAsyncThunk("foodCategories/api_v1_foodcategory_partial_update", async payload => {
  const response = await apiService.api_v1_foodcategory_partial_update(payload);
  return response.data;
});
export const api_v1_foodcategory_destroy = createAsyncThunk("foodCategories/api_v1_foodcategory_destroy", async payload => {
