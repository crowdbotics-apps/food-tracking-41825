...
export const api_v1_food_list = createAsyncThunk("foods/api_v1_food_list", async payload => {
  const response = await apiService.api_v1_food_list(payload);
  return response.data;
});
export const api_v1_food_create = createAsyncThunk("foods/api_v1_food_create", async payload => {
  const response = await apiService.api_v1_food_create(payload);
  return response.data;
});
export const api_v1_food_retrieve = createAsyncThunk("foods/api_v1_food_retrieve", async payload => {
  const response = await apiService.api_v1_food_retrieve(payload);
  return response.data;
});
export const api_v1_food_update = createAsyncThunk("foods/api_v1_food_update", async payload => {
  const response = await apiService.api_v1_food_update(payload);
  return response.data;
});
export const api_v1_food_partial_update = createAsyncThunk("foods/api_v1_food_partial_update", async payload => {
  const response = await apiService.api_v1_food_partial_update(payload);
  return response.data;
});
export const api_v1_food_destroy = createAsyncThunk("foods/api_v1_food_destroy", async payload => {
